...
<form name= 'frm_notice' method = 'POST' class = 'notice-insert'>
		<table >
			...
			<tr>
				<th scope='row'>제목</th>
				<td><input type = 'text' name= 'noticeSubject'  id = 'subject' value = "${notice.noticeSubject }"required/></td>
			</tr>
			<tr>
				<th scope='row'>작성일</th>
			...
			<tr class = 'view'>
				<td colspan ='2'>
					<div class ='content'>
						<textarea name= 'noticeDoc' rows = '7' cols ='80' required>${notice.noticeDoc }</textarea>
					</div>				
				</td>
			</tr>
		</table>
			...
			<div class = 'btns'>
				...
				<input type="text" name="noticeNo" value ="${notice.noticeNo }"size="5" />
