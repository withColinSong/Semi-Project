...
<body>
    ...
    <div class="main" id="main">
        <img class="phone-img" src="https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/ipad-2020-hero-space-wifi-select?wid=470&hei=556&fmt=png-alpha&.v=1598915064000" alt="iPad" width="600px" style="margin-top: 80px;">
        <div class="summary">
