...
<body>
    ...
    <div class="main" id="main">
        <img class="phone-img" src="https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/ipad-air-select-wifi-gold-202009?wid=470&hei=556&fmt=png-alpha&.v=1598650644000" alt="iPad Air" width="600px" style="margin-top: 50px;">
        <div class="summary">
           <form method="get" name="form">
	            <div class="테두리">
	               ...
	               판매가 : 915,000원<br>
	               색상 : 로즈골드<input type=hidden name="product_color" value= "로즈골드"><br>
	               메모리 : 256 GB<br>
	            </div>
                <div class="amount">
