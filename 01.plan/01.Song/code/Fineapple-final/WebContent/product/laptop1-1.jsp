...
<body>
    ...
    <div class="main" id="main">
        <img class="phone-img" src="https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/macbook-air-gold-select-201810?wid=452&hei=420&fmt=jpeg&qlt=95&op_usm=0.5,0.5&.v=1603332211000" alt="MacBook Air" width="600px" style="
    margin-top: 170px; border-radius: 23px">
        <div class="summary">
           <form method="get" name="form">
	            <div class="테두리">
	               <h1>MacBook Air</h1><input type= hidden name="product_name" value= "MacBook Air"><br>
	               상품코드 : MacBookAir<input type=hidden name="product_serial" value= "MacBookAir"><br>
	               판매가 : 1,290,000원<br>
    ...
    <div class = "menubar2">
        ...
        <div class="item-title">
            <a href="#main"><h2>MacBook Air</h2></a>
        ...
        <div class="item-benefits" id="item-benefits">
            <div class="item-video">
                <iframe width="1000" height="540" src="https://www.youtube.com/embed/EsuxGZOH008?autoplay=1&mute=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            
            <br/><br/><br/><br/><br/>
            <img class="ipone" width="1000px" src="https://thumbnail6.coupangcdn.com/thumbnails/remote/q89/image/retail/images/1329833623831742-242def75-0dfc-4891-aaa1-a6d566a5678d.jpg">
