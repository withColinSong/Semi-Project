...
<body>
    ...
    <div class="main" id="main">
        <img class="phone-img" src="https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/ipad-2020-hero-gold-wifi-select?wid=470&hei=556&fmt=png-alpha&.v=1598915069000" alt="iPad" width="600px" style="margin-top: 80px;">
        <div class="summary">
           <form method="get" name="form">
	            <div class="테두리">
	               <h1>iPad</h1><input type= hidden name="product_name" value= "iPad"><br>
	               상품코드 : iPad<input type=hidden name="product_serial" value= "iPad"><br>
	               판매가 : 549,000원<br>
	               색상 : 골드<input type=hidden name="product_color" value= "골드"><br>
	               메모리 : 128 GB<br>
	            </div>
                <div class="amount">
                    수량  <input type=hidden name="sell_price" value="549000">
    ...
    <div class = "menubar2">
        ...
        <div class="item-benefits" id="item-benefits">
            <div class="item-video">
                <iframe width="1000" height="540" src="https://www.youtube.com/embed/dru_qaFagLs?autoplay=1&mute=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            
            <br/><br/><br/><br/><br/>
            <img class="ipone" width="1000px" src="https://thumbnail7.coupangcdn.com/thumbnails/remote/q89/image/retail/images/188427732464565-343cc09e-0054-48e8-8ae9-0912ed148892.jpg">
