...
<body>
    ...
    <div class="main" id="main">
        <img class="phone-img" src="https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/ipad-air-select-wifi-spacegray-202009?wid=470&hei=556&fmt=png-alpha&.v=1598650646000" alt="iPad Air" width="600px" style="margin-top: 50px;">
        <div class="summary">
           <form method="get" name="form">
	            <div class="테두리">
	               <h1>iPad Air</h1><input type= hidden name="product_name" value= "iPad Air"><br>
	               상품코드 : iPadAir<input type=hidden name="product_serial" value= "iPadAir"><br>
	               판매가 : 915,000원<br>
	               색상 : 스페이스그레이<input type=hidden name="product_color" value= "스페이스그레이"><br>
	               메모리 : 256 GB<br>
	            </div>
                <div class="amount">
                    수량  <input type=hidden name="sell_price" value="915000">
    ...
    <div class = "menubar2">
        ...
        <div class="item-benefits" id="item-benefits">
            <div class="item-video">
                <iframe width="1000" height="540" src="https://www.youtube.com/embed/20hN-EtI-rI?autoplay=1&mute=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            
            <br/><br/><br/><br/><br/>
            <img class="ipone" width="1000px" src="https://thumbnail7.coupangcdn.com/thumbnails/remote/q89/image/retail/images/252726698290539-b00ddb0a-bf62-4fe9-8d93-6cd802c3183b.jpg">
