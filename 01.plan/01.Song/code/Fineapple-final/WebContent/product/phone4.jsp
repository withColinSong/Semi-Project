...
<body>
    ...
    <div class="main" id="main">
        <img class="phone-img" src="https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/iphone-12-green-select-2020?wid=940&hei=1112&fmt=png-alpha&qlt=80&.v=1604343704000" alt="iPhone 12" width="600px" style="margin-top: 70px;">
        <div class="summary">
           <form method="get" name="form">
	            <div class="테두리">
	               <h1>iPhone 12</h1><input type= hidden name="product_name" value= "iPhone 12"><br>
	               상품코드 : iPhone12<input type=hidden name="product_serial" value= "iPhone12"><br>
	               판매가 : 1,300,000원<br>
	               색상 : 그린<input type=hidden name="product_color" value= "그린"><br>
	               메모리 : 256 GB<br>
	            </div>
                <div class="amount">
                    수량  <input type=hidden name="sell_price" value="1300000">
    ...
    <div class = "menubar2">
        ...
        <div class="item-benefits" id="item-benefits">
            <div class="item-video">
                <iframe width="1000" height="540" src="https://www.youtube.com/embed/scf4inappd0?autoplay=1&mute=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            
            <br/><br/><br/><br/><br/>
            <img class="ipone" width="1000px" src="https://thumbnail9.coupangcdn.com/thumbnails/remote/q89/image/retail/images/4372094750135-05bcdcb9-a04b-478d-bd16-5f9895155e37.jpg">
