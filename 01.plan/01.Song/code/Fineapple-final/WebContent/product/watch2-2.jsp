...
<body>
    ...
    <div class="main" id="main">
        <img class="phone-img" src="https://images.samsung.com/is/image/samsung/sec-galaxy-watch-active2-r830-sm-r830nzdakoo-rperspectivepink-181094910?$PD_GALLERY_L_PNG$" alt="갤럭시 워치 액티브2" width="800px" style="margin-top: 150px; border-radius: 23px">
        <div class="summary">
           <form method="get" name="form">
	            <div class="테두리">
	               <h1>갤럭시 워치 액티브2</h1><input type= hidden name="product_name" value= "갤럭시 워치 액티브2"><br>
	               상품코드 : SM-R830NZDAKOO<input type=hidden name="product_serial" value= "SM-R830NZDAKOO"><br>
	               판매가 : 299,200원<br>
	               색상 : 핑크골드<input type=hidden name="product_color" value= "핑크골드"><br>
	               케이스 크기 : 40 mm<br>
	            </div>
                <div class="amount">
