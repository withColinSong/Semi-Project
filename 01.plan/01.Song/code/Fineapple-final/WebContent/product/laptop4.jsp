...
<body>
    ...
    <div class="main" id="main">
        <img class="phone-img" src="https://images.samsung.com/is/image/samsung/sec-notebook-nt560xda-xc58-nt560xda-xc58-frontblack-311395250?$PD_GALLERY_L_PNG$" alt="삼성 노트북 Plus2" width="600px" style="
    margin-top: 220px; border-radius: 23px">
        <div class="summary">
           <form method="get" name="form">
	            <div class="테두리">
	               <h1>삼성 노트북 Plus2</h1><input type= hidden name="product_name" value= "삼성 노트북 Plus2"><br>
	               상품코드 : NT560XDZ-G58A<input type=hidden name="product_serial" value= "NT560XDZ-G58A"><br>
	               판매가 : 900,000원<br>
	               색상 : 블레이드블랙<input type=hidden name="product_color" value= "블레이드블랙"><br>
	               메모리 : 256 GB<br>
	            </div> 
                <div class="amount">
    ...
    <div class = "menubar2">
        ...
        <div class="item-title">
            <a href="#main"><h2>삼성 노트북 Plus2</h2></a>
        ...
        <div class="item-benefits" id="item-benefits">
            <div class="item-video">
                <iframe width="1000" height="540" src="https://www.youtube.com/embed/8h1qI2pcb4g?autoplay=1&mute=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            
            <br/><br/><br/><br/><br/>
            <img class="ipone" width="1000px" src="https://thumbnail9.coupangcdn.com/thumbnails/remote/q89/image/retail/images/2020/12/18/15/1/451df8da-0ca6-40a7-adf8-d14dcacd0ea7.jpg">
