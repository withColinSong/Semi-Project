...
<body>
    ...
    <div class="main" id="main">
        <img class="phone-img" src="https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/MY752_VW_34FR+watch-40-alum-spacegray-nc-6s_VW_34FR_WF_CO_GEO_KR?wid=700&hei=700&trim=1,0&fmt=p-jpg&qlt=95&op_usm=0.5,0.5&.v=1599339905000,1601922170000" alt="apple watch" width="600px" style="margin-top: 150px; border-radius: 23px">
        <div class="summary">
           <form method="get" name="form">
	            <div class="테두리">
	               ...
	               판매가 : 599,000원<br>
	               색상 : 차콜<input type=hidden name="product_color" value= "차콜"><br>
	               케이스 크기 : 40 mm<br>
	            </div>
                <div class="amount">
