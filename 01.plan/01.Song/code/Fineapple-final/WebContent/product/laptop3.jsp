...
<body>
    ...
    <div class="main" id="main">
        <img class="phone-img" src="https://static.coupangcdn.com/image/retail/images/1463915117902914-6098dcb4-6939-4fc7-a391-04558060bfa8.jpg" alt="LG gram 16" width="600px" style="
    margin-top: 170px; border-radius: 23px">
        <div class="summary">
           <form method="get" name="form">
	            <div class="테두리">
	               <h1>LG gram 16</h1><input type= hidden name="product_name" value= "LG gram 16"><br>
	               상품코드 : 16ZD90P-GX70K<input type=hidden name="product_serial" value= "16ZD90P-GX70K"><br>
	               판매가 : 1,919,000원<br>
	               색상 : 스노우화이트<input type=hidden name="product_color" value= "스노우화이트"><br>
	               메모리 : 256 GB<br>
	            </div> 
                <div class="amount">
