...
<body>
    ...
    <div class="main" id="main">
        <img class="phone-img" src="https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/MY6V2_VW_34FR+watch-40-alum-spacegray-nc-6s_VW_34FR_WF_CO_GEO_KR?wid=700&hei=700&trim=1,0&fmt=p-jpg&qlt=95&op_usm=0.5,0.5&.v=1599112086000,1601922170000" alt="apple watch" width="600px" style="margin-top: 150px; border-radius: 23px">
        <div class="summary">
           <form method="get" name="form">
	            <div class="테두리">
	               <h1>apple watch</h1><input type= hidden name="product_name" value= "apple watch"><br>
	               상품코드 : applewatch<input type=hidden name="product_serial" value= "applewatch"><br>
	               판매가 : 599,000원<br>
	               색상 : 아틀란티 블루<input type=hidden name="product_color" value= "아틀란티 블루"><br>
	               케이스 크기 : 40 mm<br>
	            </div>
                <div class="amount">
                    수량  <input type=hidden name="sell_price" value="599000">
    ...
    <div class = "menubar2">
        ...
        <div class="item-title">
            <a href="#main"><h2>apple watch</h2></a>
        ...
        <div class="item-benefits" id="item-benefits">
            <div class="item-video">
                <iframe width="1000" height="540" src="https://www.youtube.com/embed/FtQmz9n8Ik8?autoplay=1&mute=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            
            <br/><br/><br/><br/><br/>
            <img class="ipone" width="1000px" src="https://thumbnail8.coupangcdn.com/thumbnails/remote/q89/image/retail/images/588774638130527-073f5b2c-825e-4696-b9c6-2a75edb8134f.jpg">
