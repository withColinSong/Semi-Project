...
<body>
    ...
    <div class="main" id="main">
        <img class="phone-img" src="https://images.samsung.com/is/image/samsung/sec-galaxy-z-flip-5g-f707-sm-f707nzwakoo-fronttabletopmysticwhite-308345440?$PD_GALLERY_L_PNG$" alt="갤럭시 Z 플립 5G">
        <div class="summary">
           <form method="get" name="form">
	            <div class="테두리">
	               ...
	               판매가 : 1,650,000원<br>
	               색상 : 미스틱화이트<input type=hidden name="product_color" value= "미스틱화이트"><br>
	               메모리 : 256 GB<br>
	            </div>
                <div class="amount">
    ...
    <div class = "menubar2">
        ...
        <div class="item-title">
            <a href="#main"><h2>갤럭시 Z 플립 5G</h2></a>
